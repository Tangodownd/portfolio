    ...
    <section id="tech-stack" className="py-20">
      <div className="container mx-auto px-4">
        ...
        >
            ...
            With extensive experience in web development and artificial intelligence,
            I bring a unique ability to design intelligent digital platforms that enhance
            user experience and optimize business processes. My work blends creativity
            with solid engineering principles, allowing me to deliver scalable solutions
            that integrate innovation, efficiency, and long-term value.
          </p>
        </motion.div>
      </div>
    </section>
